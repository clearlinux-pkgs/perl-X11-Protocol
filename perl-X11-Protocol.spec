...
Requires: perl-X11-Protocol-license
Requires: perl-X11-Protocol-man
...
%package man
Summary: man components for the perl-X11-Protocol package.
Group: Default

%description man
man components for the perl-X11-Protocol package.
...
mkdir -p %{_topdir}/BUILD/X11-Protocol-0.56/deblicense/
...
%install
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/perl-X11-Protocol
cp deblicense/copyright %{buildroot}/usr/share/doc/perl-X11-Protocol/deblicense_copyright
if test -f Makefile.PL; then
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/site_perl/5.26.1/X11/Auth.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Keysyms.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Connection.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Connection/FileHandle.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Connection/INETFH.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Connection/INETSocket.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Connection/Socket.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Connection/UNIXFH.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Connection/UNIXSocket.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Constants.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Ext/BIG_REQUESTS.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Ext/DPMS.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Ext/RENDER.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Ext/SHAPE.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Ext/XC_MISC.pm
/usr/lib/perl5/site_perl/5.26.1/X11/Protocol/Ext/XFree86_Misc.pm

%files license
%defattr(-,root,root,-)
/usr/share/doc/perl-X11-Protocol/deblicense_copyright
